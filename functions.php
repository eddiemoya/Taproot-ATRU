...
function atru_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Page Sidebar: Auxillary Board', 'twentytwelve' ),
		'id' => 'page-right-rail-junior-board',
		'description' => __( 'Appears on the right of the "Auxillary Board" page only. Slug should be "auxillary-board"', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
